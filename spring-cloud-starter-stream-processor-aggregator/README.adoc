...
This processor is fully based on the Aggregator component from https://docs.spring.io/spring-integration/reference/html/aggregator.html[Spring Integration].
